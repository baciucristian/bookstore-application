...
namespace Bookstore
{
    public partial class furnizoriForm : Form
    {
        ...
        public void furnizoriForm_Load(object sender, EventArgs e)
        {
            // Database connection
            ...
            string query = "SELECT denumireFurnizor, tipFurnizor, adresaFurnizor, telefonFurnizor FROM Furnizori ORDER BY denumireFurnizor";
